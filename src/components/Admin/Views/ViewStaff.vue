        ...
        <table class="user-table">
          ...
          <tbody>
            <tr v-for="user in users" :key="user.id">
              ...
              <td class="text-bold">Carlos Luis Ramires Sanchez</td>
              <td>joseluis@gmail.com</td>
              <td>+52 4811 243421</td>
              <td><span class="status-badge">Recepcionista</span></td>
        ...
        <div v-for="user in users" :key="user.id" class="user-card">
            ...
            <div class="card-info">
                <div class="top-row">
                    ...
                    <span class="status-badge">Recepcionista</span>
                </div>
...
const users = ref([
  { id: 1, name: 'Carlos Luis Ramires Sanchez', email: '...', phone: '...' },
  { id: 2, name: 'Carlos Luis Ramires Sanchez', email: '...', phone: '...' },
  { id: 3, name: 'Carlos Luis Ramires Sanchez', email: '...', phone: '...' },
  { id: 4, name: 'Carlos Luis Ramires Sanchez', email: '...', phone: '...' },
  { id: 5, name: 'Carlos Luis Ramires Sanchez', email: '...', phone: '...' },
  { id: 6, name: 'Carlos Luis Ramires Sanchez', email: '...', phone: '...' },
  { id: 7, name: 'Carlos Luis Ramires Sanchez', email: '...', phone: '...' },
  { id: 8, name: 'Carlos Luis Ramires Sanchez', email: '...', phone: '...' },      
]);
